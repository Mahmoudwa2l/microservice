...
import { CreateProductDto } from 'src/dto/create-product.dto'; // Update import
import { UpdateProductDto } from 'src/dto/update-product.dto'; // Update import
import { ProductService } from 'src/product/product.service'; // Update import

@Controller('product') // Update route
